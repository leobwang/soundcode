...
instantiations are defined below; three (\textsc{NaiveLast},
\textsc{RecBackoff}, and --- in the post-deadline follow-up ---
the fully-wired \textsc{ROCODEEntropy}) are evaluated
empirically, while \textsc{NaiveLast+Penalty}
is specified for completeness but not
evaluated at this revision (\S\ref{sec:setup}). The punchline of
